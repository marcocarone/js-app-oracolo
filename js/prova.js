      ...
      $("#scegli_carte").click(
        function() {
          ...
          while (numeroCarteSelezionabili < 3) {
            ...
            //VALIDAZIONE NUMERO UGUALE INSERITO

            listaNuova.push(numeriUtenteScelti);

            console.log("lista nuova:" + listaNuova);


            if (presenteInArray(listaNuova, numeriUtenteScelti) == false) {
              listaCarteScelte.push(listaCarteCasuale[numeriUtenteScelti - 1]);
              // se il numero dell'utente è presente
              if (presenteInArray(listaNuova, numeriUtenteScelti) == true) {
...
numUgualeInserito()
          function numUgualeInserito() {
            while (presenteInArray(listaNuova, numeriUtenteScelti) == true) {
          ...
          console.log("numero utente scelto " + listaCarteScelte);
          ...
          // richiedi numero range corretto
